...
#                       Anurag singh               #
#~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ #
#      Github     :   github.com/allthack      #
#     Instagram  :  instagram.com/alan_japensen     #
#------------------------------------------------------#
#                       #
#------------------------------------------------------#
...
echo "AGBOMB"
sleep 1
echo "                                    $WHITE Author:$RED Anurag Singh"
echo ""

}

#    Check Internet
wget -q --spider https://github.com/allthack
...
cd ..
rm -rf XLR8_BOMBER
git clone https://github.com/allthack/agbomber > /dev/null 2>&1
cd XLR8_BOMBER
chmod +x xlr8.sh
clear
echo ""
...
echo -e '''
         ...
         \e[1;91m   ╔╝\e[1;97m███████████████\e[1;91m╚╗
         \e[1;91m   ║\e[1;97m█████\e[1;92m@NUR@G\e[1;97m█████\e[1;91m║
...
''' | pv -qL 300
sleep 1.2
echo -e "                                  This is\e[1;0m Anurag singh" | pv -qL 150
echo "                                     yours allthack !" | pv -qL 150
echo ""
echo -e "     $GREEN  Ethical Hacker$WHITE |$GREEN web developer$WHITE |$GREEN Programmer" | pv -qL 10
echo ""
printf "\e[0m\e[92m                 Page Admin at$WHITE foreveryours\e[0m\n" | pv -qL 12
echo ""
echo "       $MAGENTA          My social handles are below !!" | pv -qL 10
echo ""
printf "\e[0m\e[92m          Github \e[0m\e[91m     :    \e[0m\e[96mgithub.com/allthack\e[0m\n" | pv -qL 50
echo ""
printf "\e[0m\e[92m         Instagram \e[0m\e[91m   :   \e[0m\e[96minstagram.com/sizukanobita.fc\e[0m\n" | pv -qL 50
echo ""
